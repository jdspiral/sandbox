...
add_action('genesis_before_header', 'ism_dropdown_form');
 function ism_dropdown_form() {
 	echo '<div id="panel">';
 	echo do_shortcode('[gravityform id="1" name="Contact Us" title="false" description="false"]');
 	echo '</div>';
 }

add_action('genesis_after_header', 'ism_dropdown_button');
function ism_dropdown_button() {
	echo '<div id="flip">Click to slide down panel';
	echo '</div>';
}